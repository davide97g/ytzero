...
export const api = {
  ...
  settings: () => sharedGet<{ settings: AppSettings; settings_meta: SettingsMeta }>("settings", "/settings"),
  bootstrapSettings: () => sharedGet<{ settings: AppSettings; settings_meta: SettingsMeta }>("bootstrap-settings", "/settings", { suppressAuthenticationNavigation: true }),
  dailyRotationOptions: () => http<DailyRotationOptions>("/daily-rotation/suggestions"),
